...
import org.david.alurahotel.controller.HuespedController;
...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Long idReserva) {
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/org/sam/alurahotel/imagenes/registro.png")));
