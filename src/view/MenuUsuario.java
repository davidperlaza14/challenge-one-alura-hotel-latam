package org.david.alurahotel.view;
...
public class MenuUsuario extends JFrame {
	 ...
	 */
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/org/sam/alurahotel/imagenes/aH-40px.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource("/org/sam/alurahotel/imagenes/aH-150px.png")));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/org/sam/alurahotel/imagenes/pessoas.png")));
